...
// sections
import { InvoiceListHead, InvoiceListToolbar, InvoiceMoreMenu } from '../../sections/@dashboard/e-commerce/invoice/list';
        ...
        <HeaderBreadcrumbs
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.invoice.newInvoice}
              ...
              <Table>
                ...
                <TableBody>
                  {!loading && filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { _id, designName, invoiceNo, clientName, designRate } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{clientName?clientName.clientName:'jelpp'}</TableCell>
                        <TableCell align="left">{clientName?clientName.clientId:'jelpp'}</TableCell>
                        <TableCell align="left">{designRate}</TableCell>
                        

                        <TableCell align="right">
                          <InvoiceMoreMenu onDelete={() => handleDeleteUser(_id)} userName={_id} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
